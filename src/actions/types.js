...
export const COURSE_FIELD_HAS_ERROR = 'COURSE_FIELD_HAS_ERROR'

export const SET_SUB_CATEGORY_ID = 'SET_SUB_CATEGORY_ID'
export const SET_VIDEO_URL = 'SET_VIDEO_URL'
export const SET_BANNER = 'SET_BANNER'
export const SET_BANNER_THUMBNAIL = 'SET_BANNER_THUMBNAIL'
export const SET_IS_PO = 'SET_IS_PO'
export const SET_IS_CAREER = 'SET_IS_CAREER'
...
export const COURSE_UPLOADED = 'COURSE_UPLOADED'
export const ERR_UPLOADING_COURSE = 'ERR_UPLOADING_COURSE'

export const GET_ALL_COURSES = 'GET_ALL_COURSES'
export const ALL_COURSES = 'ALL_COURSES'
export const ERR_GETTING_ALL_COURSES = 'ERR_GETTING_ALL_COURSES'

export const COURSE_UPDATED = 'COURSE_UPDATED'
export const ERR_UPDATING_COURSE = 'ERR_UPDATING_COURSE'
export const UPDATE_COURSE = 'UPDATE_COURSE'

export const UPLOAD_COURSE_VIDEO = 'UPLOAD_COURSE_VIDEO'
